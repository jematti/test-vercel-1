...
<!-- <b-container class="mt-4">
   <b-row>
     <b-col>
        <h4>¿Quiénes somos?</h4>
        <b-card img-src="https://placekitten.com/300/300" img-alt="Card image" img-left class="mb-5">
          <b-card-text>
              <h2><b-badge>Una academia que ofrece<br> programas integrales de:</b-badge></h2>
              <h4>Crecimiento personal y Liderazgo <b-badge></b-badge></h4>
              <h4> Herramientas y Oportunidades <b-badge></b-badge></h4>
              <h2><b-badge>Significado:</b-badge></h2>
              <h4>“DUX” proviene del latín que significa “líder”<b-badge></b-badge></h4>
              <h4>“ACADEMY” proviene del latín que significa “academia"<b-badge></b-badge></h4>
          </b-card-text>
        </b-card>
     </b-col>
   </b-row>
      ...
      <h4>¿Qué buscamoss?</h4>
        <b-card img-src="https://placekitten.com/300/300" img-alt="Card image" img-left class="mb-5">
          <b-card-text>
              ...
              <h4>Desarrollar y acompañar el proceso de generación de
                 líderes a través de actividades y metodologías de
                 impacto motivacional enfocados en el desarrollo de
                 aptitudes y habilidades que les permita:
              </h4>
              <h5>Experimentar el aprendizaje</h5>
              <h5>Adquirir el carácter </h5>
              <h5>Empoderar al estudiante entorno al crecimiento:Personal Social Académico Humano</h5>
          </b-card-text>
        </b-card>
   </b-row>
