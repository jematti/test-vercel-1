  ...
  <b-container >
    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
        <div class="hovereffect">
            <img class="img-responsive" src="../../assets/perfil-mujer.jpg" alt="">
            <div class="overlay">
   ...
   <b-row>
    ...
    <b-col md="6">
       <b-card
       title="Title"
       img-src="../../assets/perfil-hombre.jpg"
       img-alt="Image"
       img-top
       tag="article"
       style="max-width:20rem"
...
<style>
.perfil:hover{
 background: linear-gradient(70deg, rgb(87, 228, 169),rgb(242, 242, 242));;
}
.hovereffect {
width:100%;
height:100%;
